...
```
Hamed Babagheybi (2025). Moth-Flame Optimization (MFO) Algorithm — Implementation and Notes.  
GitHub Repository: https://github.com/hmdbbgh/MFO-Algorithm
```
...
📘 ریپو اصلی: [GitHub Repository](https://github.com/hmdbbgh/MFO-Algorithm)
